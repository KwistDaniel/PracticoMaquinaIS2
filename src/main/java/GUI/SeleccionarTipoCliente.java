...
public class SeleccionarTipoCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BClienteJ = new javax.swing.JButton();
        ...
        BClienteF.setText("Cliente Fisico");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionarTipoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionarTipoCliente().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton BClienteJ;
